            ...
            return {
                ...
                methods: {
                    ...
                    checkInView: function () {
                        ...
                        return this.getRect(), console.log(this.rect, window.innerHeight, t.options.preLoad), E && this.rect.top < window.innerHeight * t.options.preLoad && this.rect.bottom > 0 && this.rect.left < window.innerWidth * t.options.preLoad && this.rect.right > 0
                    },
                    load: function () {
                        //console.log('load')
