...
namespace Business.App_Start
{
    public class AutofacConfig
    {
        ...
        public static void Register()
        {
            ...
            //Assembly dalAss = Assembly.Load("jqb.DAL");
            ...
            Assembly serviceAss = Assembly.Load("BLL");
            ...
            object p = builder.RegisterControllers(Assembly.GetExecutingAssembly()).PropertiesAutowired();//生成具体的实例(属性注入)
